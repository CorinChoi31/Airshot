function GSliderHorizontal(_x, _y, _width, _height, _backfield_color, _backfield_alpha, _outline_color, _outline_alpha) constructor
{
	...
	value = 0; value_target = 0; value_trace = 1; value_min = 0; value_max = 0;
